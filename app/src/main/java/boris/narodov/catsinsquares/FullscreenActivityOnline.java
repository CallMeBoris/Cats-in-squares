...
public class FullscreenActivityOnline extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity_main = findViewById(R.id.onlineLayout);
    ...
    private void displayAllMessages() {
        ...
        adapter = new FirebaseListAdapter<Message>(this, Message.class, R.layout.list_item, FirebaseDatabase.getInstance().getReference()) {
            ...
            protected void populateView(View v, Message model, int position) {
                ...
                messUser = v.findViewById(R.id.message);
                messTime = v.findViewById(R.id.time);
                messText = v.findViewById(R.id.text);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == SIGN_IN_CODE){
            if (resultCode == RESULT_OK){
                Snackbar.make(activity_main, "Вы авторизованы", Snackbar.LENGTH_SHORT).show();
                displayAllMessages();
            }else {Snackbar.make(activity_main, "Вы не авторизованы", Snackbar.LENGTH_SHORT).show();
            finish();}
        }
    }
    ...
    public void talkOnline(View view){
