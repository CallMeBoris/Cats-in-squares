 ...
 */
public class FullscreenActivityOnline2 extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fullscreen_online2);
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (string.length()>MAX_LENGTH){
                    Toast.makeText(getApplicationContext(),"Слишком много напечатал", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private static int MAX_LENGTH = 150;
